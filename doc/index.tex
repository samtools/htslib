...
\begin{tabular}{|l|l|l|l|l|l|r|}
  ...
  & \multicolumn{3}{l|}{\sf n\_intv} & \# minimal intervals (for the linear index) & {\tt int32\_t} & \\\cline{2-7}
  & \multicolumn{6}{c|}{\textcolor{gray}{\it List of intervals (n=n\_intv)}} \\\cline{3-7}
  & & \multicolumn{2}{l|}{\sf ioffset} & (Virtual) file offset of the first record in the interval & {\tt uint64\_t} & \\
  \cline{1-7}
\end{tabular}}
\end{table}
