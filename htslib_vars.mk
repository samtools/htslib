...
htslib_hts_h = $(HTSPREFIX)htslib/hts.h $(htslib_bgzf_h)
htslib_razf_h = $(HTSPREFIX)htslib/razf.h $(HTSPREFIX)htslib/knetfile.h
htslib_sam_h = $(HTSPREFIX)htslib/sam.h $(htslib_bgzf_h) $(htslib_hts_h)
...
htslib_vcf_h = $(HTSPREFIX)htslib/vcf.h $(htslib_bgzf_h) $(htslib_hts_h) $(HTSPREFIX)htslib/kstring.h
